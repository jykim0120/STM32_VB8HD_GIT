...
#include	"..\common\stm32f10x_conf.h"		//by hungry 2013.02.01 for STM32F103
#endif
...
//h #define sFLASH_CS_LOW()       	GPIO_SetBits(GPIOB, GPIO_Pin_0)		//by hungry 2013.02.01 for STM32F103xxx
#define sFLASH_CS_LOW()       	GPIO_ResetBits(GPIOC, GPIO_Pin_3)		//by hungry 2013.05.08 test
 /**
  * @brief  Deselect sFLASH: Chip Select pin high
  */
//#define sFLASH_CS_HIGH()      GPIO_SetBits(sFLASH_CS_GPIO_PORT, sFLASH_CS_PIN)
//h #define sFLASH_CS_HIGH()      	GPIO_ResetBits(GPIOB, GPIO_Pin_0)		//by hungry 2013.02.01 for STM32F103xxx
#define sFLASH_CS_HIGH()      	GPIO_SetBits(GPIOC, GPIO_Pin_3)		//by hungry 2013.05.08 test
 /**
  * @}
  */ 
//h #define	sFLASH_SPI				SPI1		//by hungry 2013.02.01 for STM32F103xx
#define	sFLASH_SPI				SPI2		//by hungry 2013.05.08 test
