...
#include "stdio.h"	//by hungry 2013.06.18 test
...
void Set_System(void)
{
  ...
  */ 
  ...
  //STM_EVAL_PBInit(Button_KEY, Mode_EXTI);	//by hungry 2013.06.18 usb
  ...
  //STM_EVAL_PBInit(Button_TAMPER, Mode_EXTI);	//by hungry 2013.06.18 usb
#endif /* STM32L1XX_XD */
#endif  
  ...
  /* Configure the LEDs */
  //STM_EVAL_LEDInit(LED1);	//by hungry 2013.06.18 usb
...
void Leave_LowPowerMode(void)
{
  ...
  SystemInit();
  printf("SystemInit() \r\n");	//while(1);	//by hungry 2013.06.18 test
#if defined(STM32L1XX_MD) || defined(STM32L1XX_HD)|| defined(STM32L1XX_MD_PLUS)
...
void EXTI_Configuration(void)
{
  ...
  //EXTI_InitStructure.EXTI_Line = KEY_BUTTON_EXTI_LINE;	//by hungry 2013.06.18 usb
  EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
  EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;
  EXTI_InitStructure.EXTI_LineCmd = ENABLE;
  EXTI_Init(&EXTI_InitStructure);
  ...
  //EXTI_ClearITPendingBit(KEY_BUTTON_EXTI_LINE);	//by hungry 2013.06.18 usb
  
  /* Configure Tamper EXTI Line to generate an interrupt rising & falling edges */  
#if !defined (USE_STM32L152D_EVAL) && !defined (STM32F30X)
  //EXTI_InitStructure.EXTI_Line = TAMPER_BUTTON_EXTI_LINE;	//by hungry 2013.06.18 usb
  EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
  EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;
  EXTI_InitStructure.EXTI_LineCmd = ENABLE;
  EXTI_Init(&EXTI_InitStructure);
  ...
  //EXTI_ClearITPendingBit(TAMPER_BUTTON_EXTI_LINE);	//by hungry 2013.06.18 usb
#endif 
