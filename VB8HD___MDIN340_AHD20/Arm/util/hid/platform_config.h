...
/* Includes ------------------------------------------------------------------*/
#define	USE_STM3210E_EVAL	//by hungry 2013.06.18 usb
#define	STM32F10X_HD		//by hungry 2013.06.18 usb
 ...
 #include "stm32f10x.h"
  ...
  //#include "stm3210e_eval.h"	//by hungry 2013.06.18 usb
 #else
...
#elif defined (USE_STM3210E_EVAL)
  #define USB_DISCONNECT                      GPIOC//GPIOB  	//by hungry 2013.06.18 test
  #define USB_DISCONNECT_PIN                  GPIO_Pin_9//GPIO_Pin_14	//by hungry 2013.06.18 test
