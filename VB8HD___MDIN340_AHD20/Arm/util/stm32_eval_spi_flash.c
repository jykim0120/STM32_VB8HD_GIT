...
{
//  sFLASH_LowLevel_DeInit();	//defined in 'stm3210e_eval.c' //by hungry 2013.02.01 for STM32F103xx
}
...
//  sFLASH_LowLevel_Init();		//defined in 'stm3210e_eval.c' //by hungry 2013.02.01 for STM32F103xx, init.c
